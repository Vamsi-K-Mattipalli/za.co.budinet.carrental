...
public class TCCORP003 extends TestCore
{
    @BeforeMethod
    ...
    public void TCCORP03_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Contact Type", "debtors.dropdown.contacttype", "Credit Controller");
        x.get(0).click();
    }
