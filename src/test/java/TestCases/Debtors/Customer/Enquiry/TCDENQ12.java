...
public class TCDENQ12 extends TestCore
{
    @BeforeMethod
    ...
    public void TCDENQ12_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("debtors.menu.debtors", "debtors.menu.customers", "debtors.menu.customers.enquiry");
        driverwait();
   //     Generics.DropdownSelector("Status", "debtors.dropdown.status", "Open");
