...
public class TCDENQ10 extends TestCore
{
    @BeforeMethod
    ...
    public void TCDENQ10_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("debtors.menu.debtors", "debtors.menu.customers", "debtors.menu.customers.enquiry");
        driverwait();
        //Generics.FieldPopulate("Referral No", "debtors.field.referralno", "");
