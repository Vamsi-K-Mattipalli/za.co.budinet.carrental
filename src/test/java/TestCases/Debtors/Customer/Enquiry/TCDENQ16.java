...
public class TCDENQ16 extends TestCore
{
    @BeforeMethod
    ...
    public void TCDENQ16_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("debtors.menu.debtors", "debtors.menu.customers", "debtors.menu.customers.enquiry");
        driverwait();
       // Generics.FieldPopulate("Charges Date", "debtors.field.chargesdate", "2017-10-09");
