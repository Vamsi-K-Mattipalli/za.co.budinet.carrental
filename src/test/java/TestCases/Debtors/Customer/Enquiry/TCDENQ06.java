...
public class TCDENQ06 extends TestCore
{
    @BeforeMethod
    ...
    public void TCDENQ06_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("debtors.menu.debtors", "debtors.menu.customers", "debtors.menu.customers.enquiry");
        driverwait();
        Generics.FieldPopulate("Customer Name", "debtors.field.customername", "AIRFILTER");
