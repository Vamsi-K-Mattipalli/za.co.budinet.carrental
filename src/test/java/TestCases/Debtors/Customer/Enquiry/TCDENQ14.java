...
public class TCDENQ14 extends TestCore
{
    @BeforeMethod
    ...
    public void TCDENQ14_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("debtors.menu.debtors", "debtors.menu.customers", "debtors.menu.customers.enquiry");
        driverwait();
        Generics.FieldPopulate("Rate Code", "debtors.field.ratecode", "PO9");
