...
public class TCFIP04 extends TestCore
{
    @BeforeMethod
    ...
    public void TCFIP04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Type of Run", "debtors.dropdown.financial.typeofrun", "Reprint");
