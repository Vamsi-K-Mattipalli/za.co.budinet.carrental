...
public class TCGS012 extends TestCore
{
    @BeforeMethod
    ...
    public void TCGS12_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.FieldPopulate("Group Name", "debtors.field.groupname", "H");
