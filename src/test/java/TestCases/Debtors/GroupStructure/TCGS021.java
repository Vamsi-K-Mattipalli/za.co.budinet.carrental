...
public class TCGS021 extends TestCore
{
    @BeforeMethod
    ...
    public void TCGS21_Test1(String Username, String Password) throws Exception {
        ...
        //Generics.ClickButtonLink("debtors.button.modify", "debtors.button.modify");
