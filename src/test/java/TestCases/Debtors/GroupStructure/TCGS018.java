...
public class TCGS018 extends TestCore
{
    @BeforeMethod
    ...
    public void TCGS18_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.DropdownSelector("Country", "debtors.dropdown.country", "Namibia South Africa");
        ...
        //Generics.ClickButtonLink("debtors.button.delete", "debtors.button.delete");
    }
