...
public class TCGS017 extends TestCore
{
    @BeforeMethod
    ...
    public void TCGS17_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.FieldPopulate("Level No", "debtors.field.levelno", "H");
