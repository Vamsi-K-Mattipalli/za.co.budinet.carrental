...
public class TCGS006 extends TestCore
{
    @BeforeMethod
    ...
    public void TCGS06_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClickTab("Level Type");
        Generics.DropdownSelector("Level Type", "debtors.dropdown.leveltype", "C - Company");
        Generics.ClickButtonLink("debtors.button.submit","debtors.button.submit");
    }
