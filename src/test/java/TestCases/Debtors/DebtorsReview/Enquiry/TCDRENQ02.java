...
public class TCDRENQ02 extends TestCore
{
    @BeforeMethod
    ...
    public void TCDRENQ02_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("debtors.menu.debtors", "debtors.menu.review", "debtors.menu.review.enquiry");
        Generics.CurrentDate("From Date","debtors.field.fromdate");
