 ...
 */
public class TCPROF08 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF08_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("utilities.field.SerialNo");
