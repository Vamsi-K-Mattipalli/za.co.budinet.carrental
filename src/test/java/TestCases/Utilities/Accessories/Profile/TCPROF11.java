 ...
 */
public class TCPROF11 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF11_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClearDropDownField("utilities.dropdown.PurchRegion");
