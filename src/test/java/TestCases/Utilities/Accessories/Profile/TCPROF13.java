 ...
 */
public class TCPROF13 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF13_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClearTextField("utilities.field.PurchCost");
