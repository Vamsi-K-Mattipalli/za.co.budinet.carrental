 ...
 */
public class TCPROF17 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF17_Test1(String Username, String Password) throws Exception {
        ...
        //Generics.ClickButtonLink("utilities.button.printbar", "utilities.button.printbar");
        driver.close();
    }
