 ...
 */
public class TCPROF23 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF23_Test1(String Username, String Password) throws Exception {
    ...
    //    driver.switchTo().frame("MainTabs");
     //   Generics.ClickButtonLink("utilities.button.view", "utilities.button.view");
    //    driver.close();
    }
