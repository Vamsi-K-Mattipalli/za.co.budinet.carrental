 ...
 */
public class TCPROF10 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF10_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClearDropDownField("utilities.dropdown.AccessoryType");
