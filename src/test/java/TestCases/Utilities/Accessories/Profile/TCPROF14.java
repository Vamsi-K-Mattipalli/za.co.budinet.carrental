 ...
 */
public class TCPROF14 extends TestCore {
    @BeforeMethod
    ...
    public void TCPROF14_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClearDropDownField("utilities.dropdown.LocatedAtBranch");
