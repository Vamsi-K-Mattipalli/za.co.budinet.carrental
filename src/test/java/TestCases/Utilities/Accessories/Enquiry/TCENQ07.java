 ...
 */
public class TCENQ07 extends TestCore {
    ...
    public void TCENQ07_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Accessory Type", "utilities.dropdown.AccessoryType", "Rental");
