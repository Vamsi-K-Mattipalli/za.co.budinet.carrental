...
public class TCBRPROF043 extends TestCore {
    @BeforeMethod
    ...
    public void TCBRPROF043_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("utilities.tabs.Contact", "utilities.tabs.Contact");
        driverwait();
