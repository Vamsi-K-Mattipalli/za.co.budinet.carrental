...
public class TCBRPROF025 extends TestCore {
    @BeforeMethod
    ...
    public void TCBRPROF025_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("utilities.tabs.VehicleGrps", "utilities.tabs.VehicleGrps");
        driverwait();
