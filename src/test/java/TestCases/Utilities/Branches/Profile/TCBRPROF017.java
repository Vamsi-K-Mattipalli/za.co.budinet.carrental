...
public class TCBRPROF017 extends TestCore {
    @BeforeMethod
    ...
    public void TCBRPROF017_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("utilities.tabs.Times", "utilities.tabs.Times");
        driverwait();
