...
public class TCBRPROF011 extends TestCore {
    @BeforeMethod
    ...
    public void TCBRPROF011_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("utilities.field.LedgerProdCode");
        Generics.ClearTextField("utilities.field.AXLedgerCode");
