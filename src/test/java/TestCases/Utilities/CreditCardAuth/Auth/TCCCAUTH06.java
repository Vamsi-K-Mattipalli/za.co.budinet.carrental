 ...
 */
public class TCCCAUTH06 extends TestCore {
    @BeforeMethod
    ...
    public void TCCCAUTH06_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Effective From Date", "utilities.field.FromDate", "2017-11-30");
