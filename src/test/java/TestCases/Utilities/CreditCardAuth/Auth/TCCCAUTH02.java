 ...
 */
public class TCCCAUTH02 extends TestCore {
    @BeforeMethod
    ...
    public void TCCCAUTH02_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.DropdownSelector("Market Segment", "utilities.dropdown.MarketSegment", "Corporate");
        Generics.DropdownSelector("Vehicle Group", "utilities.dropdown.VehicleGroup", "C - Toyota Corolla Quest/similar");
        Generics.CheckBoxSelect("STD", "utilities.field.STD");
