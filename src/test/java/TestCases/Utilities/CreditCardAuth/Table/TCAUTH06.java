 ...
 */
public class TCAUTH06 extends TestCore {
    @BeforeMethod
    ...
    public void TCAUTH06_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Utilities.CredtiCardAuth("House Account");
