 ...
 */
public class TCAUTH05 extends TestCore {
    @BeforeMethod
    ...
    public void TCAUTH05_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Utilities.CredtiCardAuth("Tour Operator");
