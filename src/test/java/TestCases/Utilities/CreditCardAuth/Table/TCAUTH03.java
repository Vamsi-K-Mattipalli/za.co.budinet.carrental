 ...
 */
public class TCAUTH03 extends TestCore {
    @BeforeMethod
    ...
    public void TCAUTH03_Test1(String Username, String Password) throws Exception {
        ...
        Utilities.CredtiCardAuth("Travel Agent");
