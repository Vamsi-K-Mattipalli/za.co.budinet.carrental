...
public class TCPPROF19 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF19_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClearDropDownField("utilities.dropdown.traccode");
