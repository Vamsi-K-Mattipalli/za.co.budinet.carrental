...
public class TCPPROF21 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF21_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClearTextField("utilities.field.text2");
