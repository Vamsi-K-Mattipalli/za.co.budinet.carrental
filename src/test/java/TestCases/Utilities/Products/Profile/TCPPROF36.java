...
public class TCPPROF36 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF36_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClearDropDownField("utilities.field.colOrder");
