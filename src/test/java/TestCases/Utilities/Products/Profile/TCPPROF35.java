...
public class TCPPROF35 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF35_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClearTextField("utilities.field.colName");
