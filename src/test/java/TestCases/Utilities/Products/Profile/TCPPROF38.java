...
public class TCPPROF38 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF38_Test1(String Username, String Password) throws Exception {
    ...
    //    Generics.ClearDropDownField("utilities.dropdown.calctype");
