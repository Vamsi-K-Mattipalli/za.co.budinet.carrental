...
public class TCPPROF13 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF13_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.ClearTextField("utilities.field.ProductCode");
