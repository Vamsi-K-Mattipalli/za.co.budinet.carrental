...
public class TCPPROF37 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF37_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.ClearDropDownField("utilities.dropdown.prodMode");
