...
public class TCPPROF12 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF12_Test1(String Username, String Password) throws Exception {
        ...
        //Generics.ClearDropDownField("utilities.dropdown.prodtype");
