...
public class TCPPROF16 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF16_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.CheckBoxSelect("Default Charges Attached", "utilities.field.Global");
