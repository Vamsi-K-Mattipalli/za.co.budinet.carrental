...
public class TCPPROF11 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF11_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.ClearTextField("utilities.field.effectiveToDate");
