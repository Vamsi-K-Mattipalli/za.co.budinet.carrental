...
public class TCPPROF09 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF09_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("ops.link.reservationbyresby", "ops.link.reservationbyresby");
        driverwait();
