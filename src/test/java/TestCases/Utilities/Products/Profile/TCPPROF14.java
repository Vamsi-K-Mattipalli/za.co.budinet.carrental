...
public class TCPPROF14 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF14_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.ClearTextField("utilities.field.Description");
