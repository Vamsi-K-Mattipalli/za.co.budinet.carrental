...
public class TCPPROF10 extends TestCore {
    @BeforeMethod
    ...
    public void TCPPROF10_Test1(String Username, String Password) throws Exception {
        ...
        //Generics.ClearTextField("utilities.field.effectiveFromDate");
