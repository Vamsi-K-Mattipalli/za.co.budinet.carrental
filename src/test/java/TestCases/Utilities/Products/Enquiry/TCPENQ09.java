...
public class TCPENQ09 extends TestCore {
    @BeforeMethod
    ...
    public void TCPENQ09_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.FieldPopulate("Effective To Date", "utilities.dropdown.txtEffToDate", "2017-02-30");
