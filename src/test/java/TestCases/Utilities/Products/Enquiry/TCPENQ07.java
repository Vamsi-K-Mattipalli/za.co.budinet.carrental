...
public class TCPENQ07 extends TestCore {
    @BeforeMethod
    ...
    public void TCPENQ07_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Effective From Date", "utilities.dropdown.txtEffFromDate", "2017-02-30");
