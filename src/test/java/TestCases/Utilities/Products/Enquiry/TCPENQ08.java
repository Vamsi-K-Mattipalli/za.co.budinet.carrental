...
public class TCPENQ08 extends TestCore {
    @BeforeMethod
    ...
    public void TCPENQ08_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Effective To Date", "utilities.dropdown.txtEffToDate", "2017-06-30");
