...
public class TCPENQ04 extends TestCore {
    @BeforeMethod
    ...
    public void TCPENQ04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Product Code", "utilities.field.txtProductCode", "A1");
