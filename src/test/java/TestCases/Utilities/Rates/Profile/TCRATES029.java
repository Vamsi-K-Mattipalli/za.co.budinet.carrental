...
public class TCRATES029 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES029_Test1(String Username, String Password) throws Exception {
        ...
        Generics.CheckBoxSelect("Under Age Drivers", "utilities.field.UnderAge");
