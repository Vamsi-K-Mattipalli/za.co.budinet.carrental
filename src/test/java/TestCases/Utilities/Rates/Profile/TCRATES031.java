...
public class TCRATES031 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES031_Test1(String Username, String Password) throws Exception {
    ...
    //    Generics.CheckBoxSelect("Invoice", "utilities.field.PAYCOMM_TRA");
