...
public class TCRATES030 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES030_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.CheckBoxSelect("Invoice", "utilities.field.BreakDown");
