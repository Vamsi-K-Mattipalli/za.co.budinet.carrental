...
public class TCRATES033 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES033_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.CheckBoxSelect("Percentage Rand", "utilities.field.PAYCOMM_TRA");
