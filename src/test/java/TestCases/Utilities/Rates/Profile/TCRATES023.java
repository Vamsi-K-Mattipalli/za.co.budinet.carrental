...
public class TCRATES023 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES023_Test1(String Username, String Password) throws Exception {
        ...
        Generics.CheckBoxSelect("Free Fuel", "utilities.field.FreeFuel");
