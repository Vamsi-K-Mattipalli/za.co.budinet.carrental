...
public class TCRATES028 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES028_Test1(String Username, String Password) throws Exception {
        ...
        Generics.CheckBoxSelect("Tour Operator Rate", "utilities.field.PrintRate");
