...
public class TCRATES034 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES034_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.CheckBoxSelect("Weekend Rate", "utilities.field.PuSpecDaySat");
       // Generics.CheckBoxSelect("Weekend Rate", "utilities.field.PuSpecDaySun");
