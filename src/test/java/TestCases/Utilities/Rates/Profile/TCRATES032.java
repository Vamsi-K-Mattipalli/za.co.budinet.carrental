...
public class TCRATES032 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES032_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.CheckBoxSelect("Percentage", "utilities.field.PAYCOMM_TRA");
