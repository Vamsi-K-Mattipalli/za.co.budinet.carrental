...
public class TCRATES024 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES024_Test1(String Username, String Password) throws Exception {
        ...
        Generics.CheckBoxSelect("Vehicle Excluded", "utilities.field.VehicleExcl");
