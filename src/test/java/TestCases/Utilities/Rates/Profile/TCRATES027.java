...
public class TCRATES027 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES027_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("utilities.field.PICKupEffFromDate");
        Generics.ClearTextField("utilities.field.PICKupEffToDate");
