...
public class TCRATES009 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES009_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("utilities.menu.utilities", "utilities.menu.utilities.rates", "utilities.menu.utilities.rates.enquiry");
        driverwait();
       // Generics.FieldPopulate("Effective To Date", "utilities.field.txtEffToDate", "2017-11-10");
