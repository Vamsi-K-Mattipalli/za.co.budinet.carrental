...
public class TCRATES004 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES004_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("utilities.menu.utilities", "utilities.menu.utilities.rates", "utilities.menu.utilities.rates.enquiry");
        driverwait();
      //  Generics.FieldPopulate("Customer No", "utilities.field.txtCusNo", "120");
