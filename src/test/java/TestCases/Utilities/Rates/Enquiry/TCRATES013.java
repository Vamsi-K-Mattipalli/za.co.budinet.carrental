...
public class TCRATES013 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES013_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.DropdownSelector("Rate Type", "utilities.dropdown.cmbRateType", "Brochure Exclusive");
       // Generics.ClickButtonLink("utilities.field.txtRateCode", "utilities.field.txtRateCode");
