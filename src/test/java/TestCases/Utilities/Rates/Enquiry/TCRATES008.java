...
public class TCRATES008 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES008_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("utilities.menu.utilities", "utilities.menu.utilities.rates", "utilities.menu.utilities.rates.enquiry");
        driverwait();
       // Generics.FieldPopulate("Effective Form Date", "utilities.field.txtEffFromDate", "2017-11-05");
