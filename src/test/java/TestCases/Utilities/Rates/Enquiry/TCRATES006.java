...
public class TCRATES006 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES006_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("utilities.menu.utilities", "utilities.menu.utilities.rates", "utilities.menu.utilities.rates.enquiry");
        driverwait();
       // Generics.CheckBoxSelect("Exclusive", "utilities.field.chkExclusive");
