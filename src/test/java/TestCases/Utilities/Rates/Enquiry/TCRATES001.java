...
public class TCRATES001 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES001_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("utilities.menu.utilities", "utilities.menu.utilities.rates", "utilities.menu.utilities.rates.enquiry");
        driverwait();
       // Generics.FieldPopulate("Rate Code", "utilities.field.txtRateCode", "AAC");
