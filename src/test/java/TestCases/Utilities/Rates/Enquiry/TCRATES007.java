...
public class TCRATES007 extends TestCore {
    @BeforeMethod
    ...
    public void TCRATES007_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("utilities.menu.utilities", "utilities.menu.utilities.rates", "utilities.menu.utilities.rates.enquiry");
        driverwait();
     //   Generics.FieldPopulate("Effective Form Date", "utilities.field.txtEffFromDate", "2017-11-01");
