 ...
 */
public class PRNT003 extends TestCore {
    @BeforeMethod
    ...
    public void PRNT003_Test1(String Username, String Password) throws Exception {
     ...
     //   Utilities.PrintingPopulating();
       // Generics.ClearTextField("utilities.field.seqno");
