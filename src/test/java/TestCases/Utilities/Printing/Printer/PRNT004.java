 ...
 */
public class PRNT004 extends TestCore {
    @BeforeMethod
    ...
    public void PRNT004_Test1(String Username, String Password) throws Exception {
   ...
   //     Utilities.PrintingPopulating();
       // Generics.ClearTextField("utilities.field.prnno");
