 ...
 */
public class PRNT006 extends TestCore {
    @BeforeMethod
    ...
    public void PRNT006_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClearTextField("utilities.field.Desc");
