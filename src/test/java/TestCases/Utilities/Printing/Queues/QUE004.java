...
public class QUE004 extends TestCore {
    @BeforeMethod
    ...
    public void QUE004_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        //Generics.FieldPopulate("Run Date", "utilities.field.rundate", "2016-01-31");
