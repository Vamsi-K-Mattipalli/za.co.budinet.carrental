 ...
 */
public class REPSCH011 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH011_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
      //  Utilities.UtilitiesRequest("utilities.button.daily");
