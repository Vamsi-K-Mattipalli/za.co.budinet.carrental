 ...
 */
public class REPSCH008 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH008_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.DropdownSelector("Catagory", "utilities.dropdown.category", "Sales");
