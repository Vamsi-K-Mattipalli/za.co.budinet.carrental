 ...
 */
public class REPSCH007 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH007_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.DropdownSelector("Catagory", "utilities.dropdown.category", "All");
