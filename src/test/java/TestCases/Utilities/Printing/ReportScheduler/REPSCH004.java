 ...
 */
public class REPSCH004 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH004_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Catagory", "utilities.dropdown.category", "Branch");
