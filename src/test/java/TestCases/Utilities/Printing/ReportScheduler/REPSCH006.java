 ...
 */
public class REPSCH006 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH006_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Catagory", "utilities.dropdown.category", "Business Connexion");
