 ...
 */
public class REPSCH009 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH009_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.FieldPopulate("Report", "utilities.button.report", "BRI080P2");
