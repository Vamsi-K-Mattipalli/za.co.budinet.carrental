 ...
 */
public class REPSCH003 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH003_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Catagory", "utilities.dropdown.category", "Customer");
