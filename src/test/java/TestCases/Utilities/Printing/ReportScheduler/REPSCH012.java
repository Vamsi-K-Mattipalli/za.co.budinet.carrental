 ...
 */
public class REPSCH012 extends TestCore {
    @BeforeMethod
    ...
    public void REPSCH012_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
       // Utilities.UtilitiesRequest("utilities.button.weekly");
