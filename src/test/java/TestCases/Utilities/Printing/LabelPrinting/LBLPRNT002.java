...
public class LBLPRNT002 extends TestCore {
    @BeforeMethod
    ...
    public void LBLPRNT002_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Printer Number", "utilities.field.printerno", "999");
