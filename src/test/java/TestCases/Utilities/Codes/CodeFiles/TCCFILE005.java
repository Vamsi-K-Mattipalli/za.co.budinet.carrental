...
public class TCCFILE005 extends TestCore {
    @BeforeMethod
    ...
    public void TCCFILE005_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Code Type", "utilities.codefiles.field.codetype", "TEST");
        Generics.FieldPopulate("Description", "utilities.codefiles.field.description", "TESTING Description");
