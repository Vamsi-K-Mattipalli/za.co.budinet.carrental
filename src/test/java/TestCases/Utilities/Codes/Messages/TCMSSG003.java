...
public class TCMSSG003 extends TestCore {
    @BeforeMethod
    ...
    public void TCMSSG003_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.FieldPopulate("Message", "utilities.messages.field.textAreaMsg", "Done for users");
