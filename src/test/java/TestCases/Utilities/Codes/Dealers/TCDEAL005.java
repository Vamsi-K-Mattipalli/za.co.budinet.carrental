...
public class TCDEAL005 extends TestCore {
    @BeforeMethod
    ...
    public void TCDEAL005_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClickTab("Dealer Models");
      //  Generics.DropdownSelector("Load Dealer Models", "utilities.codes.dropdown.loaddealermodels", "AUDI");
