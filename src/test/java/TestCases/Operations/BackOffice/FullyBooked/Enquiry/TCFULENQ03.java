...
public class TCFULENQ03 extends TestCore {
    @BeforeMethod
    ...
    public void TCFULENQ03_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Region", "fullybooked.dropdown.Region", "Gauteng Central");
