...
public class TCFULENQ04 extends TestCore {
    @BeforeMethod
    ...
    public void TCFULENQ04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearDropDownField("fullybooked.dropdown.Country");
        Generics.DropdownSelector("Branch", "fullybooked.dropdown.Branch", "OR Tambo Intl Airport JS");
