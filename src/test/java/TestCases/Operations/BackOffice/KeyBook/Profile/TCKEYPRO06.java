...
public class TCKEYPRO06 extends TestCore {
    @BeforeMethod
    ...
    public void TCKEYPRO06_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.FieldPopulate("RegNo", "keybook.field.RegNo", "BW76BJGP");
