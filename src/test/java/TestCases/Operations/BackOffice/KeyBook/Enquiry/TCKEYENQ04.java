...
public class TCKEYENQ04 extends TestCore {
    @BeforeMethod
    ...
    public void TCKEYENQ04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Date From", "keybook.field.txtFromDate", "2017-07-30");
