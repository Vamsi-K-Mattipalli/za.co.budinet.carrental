...
public class TCUNET05 extends TestCore {
    @BeforeMethod
    ...
    public void TCUNET05_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.CheckBoxSelect("Write Off", "backoffice.field.writeoff");
     //   Generics.ClickButtonLink("backoffice.button.submit", "backoffice.button.submit");
        driver.close();
    }
