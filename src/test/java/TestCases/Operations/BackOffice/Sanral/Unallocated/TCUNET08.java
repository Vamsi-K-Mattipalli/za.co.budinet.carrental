...
public class TCUNET08 extends TestCore {
    @BeforeMethod
    ...
    public void TCUNET08_Test1(String Username, String Password) throws Exception {
        ...
        //Generics.FieldPopulate("Transaction Time", "backoffice.field.transactiontime", "08:00");
