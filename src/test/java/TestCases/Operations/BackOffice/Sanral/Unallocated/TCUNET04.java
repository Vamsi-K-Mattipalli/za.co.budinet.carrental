...
public class TCUNET04 extends TestCore {
    @BeforeMethod
    ...
    public void TCUNET04_Test1(String Username, String Password) throws Exception {
...
//        Generics.ClickButtonLink("backoffice.button.selectmovement", "backoffice.button.selectmovement");
        driver.close();
    }
