...
public class TCSUBENQ17 extends TestCore {
    @BeforeMethod
    ...
    public void TCSUBENQ17_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("order.link.vehiclegroups", "order.link.vehiclegroups");
        Generics.DropdownSelector("Order Type", "order.dropdown.ordertype", "Sub Hire Order");
        Generics.DropdownSelector("Vehicle Group", "vehicle.dropdown.vehiclegroup", "B - Ford Fiesta/similar");
