...
public class TCSUBENQ18 extends TestCore {
    @BeforeMethod
    ...
    public void TCSUBENQ18_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Status", "order.dropdown.orderstatus", "Pending");
