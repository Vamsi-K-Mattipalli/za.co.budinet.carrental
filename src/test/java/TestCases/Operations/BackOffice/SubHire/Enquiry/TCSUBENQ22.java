...
public class TCSUBENQ22 extends TestCore {
    @BeforeMethod
    ...
    public void TCSUBENQ22_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("order.link.regions", "order.link.regions");
        Generics.DropdownSelector("Order Type", "order.dropdown.ordertype", "Sub Hire Order");
        Generics.DropdownSelector("Status", "order.dropdown.orderstatus", "Cancelled");
