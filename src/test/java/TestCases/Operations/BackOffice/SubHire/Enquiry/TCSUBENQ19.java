...
public class TCSUBENQ19 extends TestCore {
    @BeforeMethod
    ...
    public void TC019_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("order.link.countrys", "order.link.countrys");
