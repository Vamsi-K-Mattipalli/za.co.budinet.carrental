 ...
 */
public class TCSUBENQ01 extends TestCore {
    ...
    public void TCSUBENQ01_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
       // Menu.NavigateTo4("operations.menu.operation", "operations.menu.backoffice",
        //        "operations.menu.backoffice.subhire",
       //         "operations.menu.backoffice.subhire.enquiry");
