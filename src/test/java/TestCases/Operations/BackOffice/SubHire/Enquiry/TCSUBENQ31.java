...
public class TCSUBENQ31 extends TestCore {
    @BeforeMethod
    ...
    public void TCSUBENQ31_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("order.link.dateranges", "order.link.dateranges");
        Generics.DropdownSelector("Order Type", "order.dropdown.ordertype", "Sub Hire Order");
        Generics.FieldPopulate("From Date", "order.dropdown.orderfdate", "2017-07-22");
        Generics.FieldPopulate("To Date", "order.dropdown.ordertdate", "2017-08-25");
