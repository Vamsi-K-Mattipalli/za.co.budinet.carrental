...
public class TCTRMAN02 extends TestCore {
    @BeforeMethod
    ...
    public void TCTRAN02_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.FieldPopulate("Level Number", "maintance.field.levno", "1");
     //   Generics.ClickButtonLink("maintance.button.view", "maintance.button.view");
        driver.close();
    }
