package TestCases.Operations.Rental.Delivery;
...
public class TCDEL002 extends TestCore {
    @BeforeMethod
    ...
    public void TCDEL002_Test1(String Username, String Password) throws Exception {
