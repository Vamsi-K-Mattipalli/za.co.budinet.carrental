package TestCases.Operations.Rental.MultipleUtilites.TermMultMvmnts;
 ...
 */
public class TCMUTMM026 extends TestCore {
    ...
    @Story("TERM MULTIPLE MOVEMENTS")
    @Test(dataProvider = "login", dataProviderClass = DataProviders.class)
    public void TCMUTMM026_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo4("operations.menu.operation", "operations.menu.rental",
                "operations.menu.rental.multiple","operations.menu.rental.multiple.term.multi");
        driverwait();
