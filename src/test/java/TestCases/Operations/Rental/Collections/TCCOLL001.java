package TestCases.Operations.Rental.Collections;
...
public class TCCOLL001 extends TestCore {
    @BeforeMethod
    ...
    public void TCCOLL002_Test1(String Username, String Password) throws Exception {
