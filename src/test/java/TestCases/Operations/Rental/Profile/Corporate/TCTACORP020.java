...
public class TCTACORP020 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP020_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("raprofile.field.duebacktime");
        Generics.FieldPopulate("Time", "raprofile.field.duebacktime", "2000");
