...
public class TCTACORP047 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP047_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("ID No", "raprofile.field.identifyingno", "791129520008");
        ...
        Generics.PopMessege("ID No. 791129520008 invalid - May not be less than 13 digits");
        driverwait();
    }
