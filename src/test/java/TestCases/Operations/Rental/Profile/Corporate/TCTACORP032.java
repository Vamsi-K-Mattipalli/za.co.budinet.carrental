...
public class TCTACORP032 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP032_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("raprofile.field.surname");
        Generics.ClearTextField("raprofile.field.identifyingsurname");
        ...
        Generics.PopMessege("Renter Title, First Name and Surname required if ID No.not entered - Please re-enter");
        driverwait();
