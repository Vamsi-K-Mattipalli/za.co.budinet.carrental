...
public class TCTACORP039 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP039_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.ClickButtonLink("operation.button.printra", "operation.button.printra");
        driverwait();
    }
