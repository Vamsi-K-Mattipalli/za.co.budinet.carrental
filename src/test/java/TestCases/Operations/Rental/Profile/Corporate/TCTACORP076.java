...
public class TCTACORP076 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP076_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("raprofile.button.binacularreferraIATA", "raprofile.button.binacularreferraIATA");
    }
