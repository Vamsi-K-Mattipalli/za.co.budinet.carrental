...
public class TCTACORP007 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP07_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("raprofile.field.firstname1");
        Generics.FieldPopulate("First Name 1", "raprofile.field.firstname1", "Chenge Firstname");
