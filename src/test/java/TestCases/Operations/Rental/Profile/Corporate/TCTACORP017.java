...
public class TCTACORP017 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP017_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Time", "raprofile.field.time", "1200");
