...
public class TCTACORP054 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP054_Test1(String Username, String Password) throws Exception {
    ...
    //    Generics.CheckBoxSelect("Overrite Fully Booked", "raprofile.field.ignorefullybooked");
