...
public class TCTACORP048 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP048_Test1(String Username, String Password) throws Exception {
        ...
        Reservation.minipopulate("SA ID", "NNNNPPPP");
        Generics.ClickButtonLink("raprofile.button.retrievedefaults", "raprofile.button.retrievedefaults");
        Generics.PopMessege("Renter NNNNPPPP does not exist - Please re-enter");
    }
