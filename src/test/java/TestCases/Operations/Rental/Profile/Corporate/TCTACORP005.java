...
public class TCTACORP005 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP005_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClearTextField("raprofile.field.initials");
        //Generics.FieldPopulate("Intials", "raprofile.field.initials", "COC");
