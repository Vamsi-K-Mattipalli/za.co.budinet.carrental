...
public class TCTACORP053 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP053_Test1(String Username, String Password) throws Exception {
        ...
        Reservation.minipopulate("Passport", "YYYYY");
        Generics.ClickButtonLink("raprofile.button.retrievedefaults", "raprofile.button.retrievedefaults");
        Generics.PopMessege("Renter YYYYY does not exist - Please re-enter");
    }
