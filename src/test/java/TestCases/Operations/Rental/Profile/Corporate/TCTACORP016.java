...
public class TCTACORP016 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP016_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Date", "raprofile.field.date", "2017-11-30");
