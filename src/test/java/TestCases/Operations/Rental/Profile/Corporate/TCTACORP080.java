...
public class TCTACORP080 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP080_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("raprofile.button.retrievecustomerdefaults", "raprofile.button.retrievecustomerdefaults");
    }
