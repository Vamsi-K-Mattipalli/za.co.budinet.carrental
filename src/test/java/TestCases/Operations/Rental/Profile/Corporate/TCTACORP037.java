...
public class TCTACORP037 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP037_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.ClickButtonLink("operation.button.viewdamages", "operation.button.viewdamages");
        driverwait();
    }
