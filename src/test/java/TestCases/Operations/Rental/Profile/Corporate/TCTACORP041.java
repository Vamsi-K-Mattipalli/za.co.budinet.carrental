...
public class TCTACORP041 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP041_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.ClickButtonLink("operation.button.newra", "operation.button.newra");
        driverwait();
    }
