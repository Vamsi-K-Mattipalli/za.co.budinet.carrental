...
public class TCTACORP040 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP040_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.ClickButtonLink("operation.button.cancel", "operation.button.cancel");
        driverwait();
    }
