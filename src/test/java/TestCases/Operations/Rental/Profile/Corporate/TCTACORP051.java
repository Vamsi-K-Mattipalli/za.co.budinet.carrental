...
public class TCTACORP051 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP051_Test1(String Username, String Password) throws Exception {
        ...
        Reservation.minipopulate("SA ID", "740528007208");
        Generics.ClickButtonLink("raprofile.button.retrievedefaults", "raprofile.button.retrievedefaults");
        Generics.PopMessege("Renter 740528007208 does not exist - Please re-enter");
    }
