...
public class TCTACORP063 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP063_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.DropdownSelector("Due Back Branch", "raprofile.dropdown.duebackbranch", "OR Tambo Intl Airport JS");
      //  Generics.ClickButtonLink("raprofile.button.binaculardue", "raprofile.button.binaculardue");
    }
