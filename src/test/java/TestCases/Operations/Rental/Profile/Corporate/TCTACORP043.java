...
public class TCTACORP043 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP043_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.ClickButtonLink("operation.link.resevetionsbyres", "operation.link.resevetionsbyres");
       // Reservation.SearchRA("JS72037I01");
        driverwait();
      //  Generics.ClickButtonLink("operation.button.smsnotification", "operation.button.smsnotification");
        driverwait();
    }
