...
public class TCTACORP014 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP014_Test1(String Username, String Password) throws Exception {
   ...
   //     Generics.DropdownSelector("Vehicle Group", "raprofile.dropdwon.vehiclegroup", "H - Mercededes C Class Auto/sim");
