...
public class TCTACORP050 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP050_Test1(String Username, String Password) throws Exception {
        ...
        Reservation.minipopulate("SA ID", "025");
        Generics.ClickButtonLink("raprofile.button.retrievedefaults", "raprofile.button.retrievedefaults");
        Generics.PopMessege("Renter 025 does not exist - Please re-enter");
    }
