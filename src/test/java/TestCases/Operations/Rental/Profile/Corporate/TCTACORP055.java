...
public class TCTACORP055 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP055_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("ID Type", "raprofile.dropdown.idtype", "Botswana ID");
