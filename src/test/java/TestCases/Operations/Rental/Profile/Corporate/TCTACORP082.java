...
public class TCTACORP082 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP082_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("raprofile.button.binacularreserverate", "raprofile.button.binacularreserverate");
    }
