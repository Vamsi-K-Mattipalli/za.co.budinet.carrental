...
public class TCTACORP004 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("Title", "raprofile.dropdown.title", "Miss");
