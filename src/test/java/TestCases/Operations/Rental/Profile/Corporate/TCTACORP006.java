...
public class TCTACORP006 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP006_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Surname", "raprofile.field.identifyingsurname", "Mlambo");
