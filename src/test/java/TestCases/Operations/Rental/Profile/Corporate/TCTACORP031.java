...
public class TCTACORP031 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP031_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearDropDownField("raprofile.dropdown.idtype");
        ...
        Generics.PopMessege("Renter Identifier may not be entered if Renter Type not entered. Please re-enter");
        driverwait();
    }
