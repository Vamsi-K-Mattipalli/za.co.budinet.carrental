...
public class TCTACORP045 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP045_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("ID No", "raprofile.field.identifyingno", "79112ghgfhghgfhdfd");
        ...
        Generics.PopMessege("Format of Id No. 79112ghgfhghgfhdfd invalid - please re-enter");
        driverwait();
    }
