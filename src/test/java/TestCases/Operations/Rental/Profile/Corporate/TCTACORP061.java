...
public class TCTACORP061 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP061_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.ClickButtonLink("raprofile.button.binacula", "raprofile.button.binacula");
