...
public class TCTACORP018 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP018_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearDropDownField("raprofile.dropdown.duebackbranch");
        Generics.DropdownSelector("Due Back Branch", "raprofile.dropdown.duebackbranch", "Centurion Hotel CV");
