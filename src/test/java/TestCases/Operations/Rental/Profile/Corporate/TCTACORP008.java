...
public class TCTACORP008 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP008_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearDropDownField("raprofile.dropdown.pickupbranch");
