...
public class TCTACORP065 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP065_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.ClickButtonLink("raprofile.button.binacularIATA", "raprofile.button.binacularIATA");
    }
