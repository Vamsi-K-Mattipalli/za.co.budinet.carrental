...
public class TCTACORP042 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP042_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.ClickButtonLink("operation.button.alletoll", "operation.button.alletoll");
        driverwait();
    }
