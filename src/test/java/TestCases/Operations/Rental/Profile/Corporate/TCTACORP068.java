...
public class TCTACORP068 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP068_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("raprofile.button.binacularreferralaccount", "raprofile.button.binacularreferralaccount");
    }
