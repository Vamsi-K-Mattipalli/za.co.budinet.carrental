...
public class TCTACORP030 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP030_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("raprofile.field.telno");
        ...
        Generics.PopMessege("Tel No required - please re-enter");
        driverwait();
    }
