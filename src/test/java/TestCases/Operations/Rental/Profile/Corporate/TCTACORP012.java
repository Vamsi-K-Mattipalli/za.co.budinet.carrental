...
public class TCTACORP012 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP012_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("raprofile.field.duebackdate");
        Generics.FieldPopulate("Date", "raprofile.field.duebackdate", "2017-12-31");
