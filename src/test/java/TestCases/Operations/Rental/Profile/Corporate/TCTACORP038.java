...
public class TCTACORP038 extends TestCore {
    @BeforeMethod
    ...
    public void TCTACORP038_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        Generics.ClickButtonLink("operation.button.badra", "operation.button.badra");
        driverwait();
    }
