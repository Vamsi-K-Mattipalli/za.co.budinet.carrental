...
public class TCD2D005 extends TestCore {
    @BeforeMethod
    ...
    public void TCD2D005_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.FieldPopulate("Bidvest No", "raprofile.field.bidvestno", "JS51690I01");
