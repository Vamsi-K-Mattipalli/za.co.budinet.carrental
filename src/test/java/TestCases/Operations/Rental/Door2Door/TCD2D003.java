...
public class TCD2D003 extends TestCore {
    @BeforeMethod
    ...
    public void TCD2D003_Test1(String Username, String Password) throws Exception {
    ...
    //    Generics.FieldPopulate("Bidvest No", "raprofile.field.bidvestno", "JS51687I01");
