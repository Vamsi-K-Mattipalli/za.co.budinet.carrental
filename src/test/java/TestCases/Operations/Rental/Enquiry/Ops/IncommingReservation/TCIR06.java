 ...
 */
public class TCIR06 extends TestCore {
    ...
    public void TCRAENQSEC01_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.FieldPopulate("Time", "ops.field.TRANSTIME", "0800");
