 ...
 */
public class TCRAENQSEC12 extends TestCore {
    ...
    public void TCRAENQSEC12_Test1(String Username, String Password) throws Exception {
       ...
       // Generics.CheckBoxSelect("All Branches", "ops.field.ALLBRANCHES");
