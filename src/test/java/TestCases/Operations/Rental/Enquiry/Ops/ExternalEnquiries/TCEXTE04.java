 ...
 */
public class TCEXTE04 extends TestCore {
    ...
    public void TCEXTE04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("FTP Date", "ops.field.FTPDATE", "2017-09-30");
