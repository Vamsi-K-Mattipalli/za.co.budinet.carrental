 ...
 */
public class TCRAENQSEC08 extends TestCore {
    ...
    public void TCRAENQSEC08_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("RA Number","ops.field.RANO","JS15723J01");
