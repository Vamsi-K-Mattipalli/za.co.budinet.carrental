 ...
 */
public class TCRAENQSEC07 extends TestCore {
    ...
    public void TCRAENQSEC07_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("RA Number","ops.field.RANO","JS04198J01");
