...
public class TCFUTE006 extends TestCore
{
    @BeforeMethod
    ...
    public void TCFUTE006_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("To Time", "fleetute.field.totime", "2000");
