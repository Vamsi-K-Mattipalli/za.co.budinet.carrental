...
public class TC07 extends TestCore
{
    @BeforeMethod
    ...
    public void TC07_Test1(String Username, String Password) throws Exception {
        ...
        driverwait();
        //Generics.ClickButtonLink("fleetute.button.selectionbrh", "fleetute.button.selectionbrh");
        driver.close();
    }
