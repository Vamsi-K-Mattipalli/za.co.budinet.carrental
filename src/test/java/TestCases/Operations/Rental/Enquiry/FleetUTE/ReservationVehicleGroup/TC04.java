...
public class TC04 extends TestCore
{
    @BeforeMethod
    ...
    public void TC04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("fleetute.field.pickupdatebrg");
        Generics.CurrentDate("Pick Up Date", "fleetute.field.pickupdatebrg");
