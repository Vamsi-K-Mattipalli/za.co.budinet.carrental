...
public class TCFUTE005 extends TestCore
{
    @BeforeMethod
    ...
    public void TCFUTE005_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FutureDate("To Date", "fleetute.field.todate");
