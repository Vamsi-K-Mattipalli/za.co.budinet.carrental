...
public class TCFUTE004 extends TestCore
{
    @BeforeMethod
    ...
    public void TCFUTE004_Test1(String Username, String Password) throws Exception {
        ...
        Generics.DropdownSelector("At Branch", "fleetute.dropdown.atbranch", "OR Tambo Intl Airport JS");
        Generics.CurrentDate("From Date", "fleetute.field.fromdate");
        Generics.FieldPopulate("From Time", "fleetute.field.fromdate", "1000");
