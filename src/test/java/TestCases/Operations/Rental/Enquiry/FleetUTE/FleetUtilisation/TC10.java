...
public class TC10 extends TestCore
{
    @BeforeMethod
    ...
    public void TC10_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("fleetute.button.backbfu", "fleetute.button.backbfu");
        driver.close();
    }
