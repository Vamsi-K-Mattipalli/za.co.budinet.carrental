...
public class TCCHFUER001 extends TestCore {
    @BeforeMethod
    ...
    public void TCCHFUER001_Test1(String Username, String Password) throws Exception {
        ...
        Reservation.minipopulate(" Chauffeur", "Alvin Willems");
