 ...
 */
public class TCINDV005 extends TestCore {
    ...
    public void TCINDV05_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Optimal Rate Code", "qoute.field.optimalrate", "RC1");
