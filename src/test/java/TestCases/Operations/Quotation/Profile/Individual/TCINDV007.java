 ...
 */
public class TCINDV007 extends TestCore {
    ...
    public void TCINDV07_Test1(String Username, String Password) throws Exception {
        ...
        Generics.CheckBoxSelect("Fully Book", "qoute.field.fullybook");
