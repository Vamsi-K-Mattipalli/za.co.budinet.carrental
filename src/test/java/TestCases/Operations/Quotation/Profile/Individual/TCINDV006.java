 ...
 */
public class TCINDV006 extends TestCore {
    ...
    public void TCINDV06_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.FieldPopulate("Specific Rate", "qoute.field.speciafyrate", "RC01");
