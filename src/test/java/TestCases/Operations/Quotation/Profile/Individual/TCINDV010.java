 ...
 */
public class TCINDV010 extends TestCore {
    ...
    public void TCINDV10_Test1(String Username, String Password) throws Exception {
        ...
        Generics.CheckBoxSelect("SCDW", "qoute.button.weavers");
