 ...
 */
public class TCTAfCR131 extends TestCore {
    ...
    public void TCTAfCR131_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("On Behalf of Account No", "qoute.field.txtOnBehalfOfNo", "0123456");
        Generics.FieldPopulate("On Behalf of Account Name", "qoute.field.txtOnBehalfOfName", "ABCJJOJ");
