 ...
 */
public class TCTACR004 extends TestCore {
    ...
    @Description("Description : Capture  International  Casual Renter Quote and Add Local Rate code")
    @Test(dataProvider = "login", dataProviderClass = DataProviders.class)
    public void TCTAT004_Test1(String Username, String Password) throws Exception {
