 ...
 */
public class TCCR012 extends TestCore {
    ...
    public void TCCR12_Test1(String Username, String Password) throws Exception {
      ...
      //  Generics.FieldPopulate("Local Rate", "qoute.field.txtQuoteRateCode", "FHH");
