 ...
 */
public class TCCR017 extends TestCore {
    ...
    public void TCCR17_Test1(String Username, String Password) throws Exception {
       ...
       //// Generics.ClearDropDownField("qoute.dropdown.cmbPUBranch");
        Generics.ClickButtonLink("qoute.button.submitqoute", "qoute.button.submitqoute");
        //Generics.PopMessege(" Pick Up Branch required - please re-enter");
        driver.close();
