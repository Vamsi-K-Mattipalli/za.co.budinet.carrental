 ...
 */
public class TCQUOENQ10 extends TestCore {
    ...
    public void TCQUOENQ10_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("PickUp Date", "qoutation.field.PUDATE", "2016-12-31");
        ...
        Generics.ClickButtonLink("qoutation.link.ranumbers", "qoutation.link.ranumbers");
        driver.close();
