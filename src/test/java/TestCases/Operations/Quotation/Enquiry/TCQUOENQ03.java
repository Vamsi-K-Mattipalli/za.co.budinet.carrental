 ...
 */
public class TCQUOENQ03 extends TestCore {
    ...
    public void TCQUOENQ03_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("operations.menu.operation", "operations.menu.quotation", "operations.menu.quotation.enquiry");
        driverwait();
        Generics.FieldPopulate("Renter Name", "qoutation.field.RENTERNAME", "JAN");
