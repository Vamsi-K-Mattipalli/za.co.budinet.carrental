 ...
 */
public class TCQUOENQ06 extends TestCore {
    ...
    public void TCQUOENQ06_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("operations.menu.operation", "operations.menu.quotation", "operations.menu.quotation.enquiry");
        driverwait();
      //  Generics.FieldPopulate("PickUp Time", "qoutation.field.PUTIME", "0800");
