 ...
 */
public class TCQUOENQ02 extends TestCore {
    ...
    public void TCQUOENQ02_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("operations.menu.operation", "operations.menu.quotation", "operations.menu.quotation.enquiry");
        driverwait();
        Generics.FieldPopulate("Qoutation Reference", "qoutation.field.QUOTEREF", "5000001817");
