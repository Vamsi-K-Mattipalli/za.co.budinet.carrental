...
public class TCNRENQ07 extends TestCore {
    @BeforeMethod
    ...
    public void TCNRENQ07_Test1(String Username, String Password) throws Exception {
     ...
     //   Generics.FieldPopulate("Non-Revenue Number", "nonrevenue.field.NONREVNO", "1WNR00015014");
      ...
      //  driver.switchTo().frame("core");
       // Generics.ClickButtonLink("nonrevenue.button.viewdameges", "nonrevenue.button.viewdameges");
        driver.close();
    }
