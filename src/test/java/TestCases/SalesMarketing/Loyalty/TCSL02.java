 ...
 */
public class TCSL02 extends TestCore {
    ...
    public void TCSL02_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("RA Number", "loyalty.field.txtRANo", "DM85828F01");
        Generics.ClearDropDownField("loyalty.dropdown.cmbLoyaltyProgram");
