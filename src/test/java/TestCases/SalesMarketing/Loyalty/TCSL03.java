 ...
 */
public class TCSL03 extends TestCore {
    ...
    public void TCSL03_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("loyalty.field.txtLoyaltyNo");
