 ...
 */
public class TCSR04 extends TestCore {
    ...
    public void TCSR04_Test1(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Renter Initials", "renter.field.RENTERINITIALS", "J");
