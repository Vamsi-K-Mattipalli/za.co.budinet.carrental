 ...
 */
public class TCSR07 extends TestCore {
    ...
    public void TCSR07_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("salesmarketing.menu.sales", "salesmarketing.menu.renter", "salesmarketing.menu.renter.enquiry");
        driverwait();
        Generics.DropdownSelector("Loyalty Program", "renter.dropdown.LOYALTYPROGRAM", "Voyager");
