 ...
 */
public class TCSR13 extends TestCore {
    ...
    public void TCSR13_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("renter.tab.addresshistory", "renter.tab.addresshistory");
        driver.close();
