 ...
 */
public class TCSR06 extends TestCore {
    ...
    public void TCSR06_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("salesmarketing.menu.sales", "salesmarketing.menu.renter", "salesmarketing.menu.renter.enquiry");
        driverwait();
        Generics.DropdownSelector("Renter Name", "renter.field.RENTERNAME", "Smith");
