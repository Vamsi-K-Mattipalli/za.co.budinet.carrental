 ...
 */
public class TCSR08 extends TestCore {
    ...
    public void TCSR08_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("salesmarketing.menu.sales", "salesmarketing.menu.renter", "salesmarketing.menu.renter.enquiry");
        driverwait();
        Generics.FieldPopulate("Loyalty Program Number", "renter.field.LOYALTYNO", "134543");
