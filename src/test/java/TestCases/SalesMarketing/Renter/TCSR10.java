 ...
 */
public class TCSR10 extends TestCore {
    ...
    public void TCSR10_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("renter.field.BLACKLIST", "renter.field.BLACKLIST");
