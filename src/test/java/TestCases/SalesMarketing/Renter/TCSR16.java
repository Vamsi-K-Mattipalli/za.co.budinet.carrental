 ...
 */
public class TCSR16 extends TestCore {
    ...
    public void TCSR16_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("renter.tab.preference", "renter.tab.preference");
        driver.close();
