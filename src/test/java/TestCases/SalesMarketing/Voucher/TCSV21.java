 ...
 */
public class TCSV21 extends TestCore {
    ...
    public void TCSV21_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("voucher.tab.history", "voucher.tab.history");
        driver.close();
    }
