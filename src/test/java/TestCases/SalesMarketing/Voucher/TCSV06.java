 ...
 */
public class TCSV06 extends TestCore {
    ...
    public void TCSV06_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("salesmarketing.menu.sales", "salesmarketing.menu.vourcher", "salesmarketing.menu.vourcher.enquiry");
        driverwait();
        Generics.FieldPopulate("Voucher No", "voucher.field.VOUCHERNO1", "14154810");
