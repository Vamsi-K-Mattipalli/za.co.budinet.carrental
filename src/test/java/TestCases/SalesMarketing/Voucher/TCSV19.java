 ...
 */
public class TCSV19 extends TestCore {
    ...
    public void TCSV19_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("voucher.tab.allocation", "voucher.tab.allocation");
        driver.close();
    }
