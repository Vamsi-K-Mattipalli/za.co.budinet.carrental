 ...
 */
public class TCSV20 extends TestCore {
    ...
    public void TCSV20_Test1(String Username, String Password) throws Exception {
        ...
        Generics.ClickButtonLink("voucher.tab.cancel", "voucher.tab.cancel");
        driver.close();
    }
