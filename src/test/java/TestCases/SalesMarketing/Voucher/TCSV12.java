 ...
 */
public class TCSV12 extends TestCore {
    ...
    public void TCSV12_Test1(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("salesmarketing.menu.sales", "salesmarketing.menu.vourcher", "salesmarketing.menu.vourcher.enquiry");
        driverwait();
        Generics.FieldPopulate("Referral Account Number", "voucher.field.REFERRALACCNO", "51508671842");
