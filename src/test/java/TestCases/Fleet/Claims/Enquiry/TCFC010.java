 ...
 */
public class TCFC010 extends TestCore {
    @BeforeMethod
    ...
    public void TCFC010_FLEET_CLAIMS_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.claims", "fleet.menu.claims.enquiry");
        driverwait();
        driverwait();
        Generics.FieldPopulate("Reg No", "claims.field.regno", "CAW71664");
