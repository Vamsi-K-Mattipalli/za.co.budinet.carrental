 ...
 */
public class TCFC013 extends TestCore {
    @BeforeMethod
    ...
    public void TCFC013_FLEET_CLAIMS_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.claims", "fleet.menu.claims.enquiry");
        driverwait();
        driverwait();
        Generics.CheckBoxSelect("Rental Damage", "claims.field.rentaldamage");
