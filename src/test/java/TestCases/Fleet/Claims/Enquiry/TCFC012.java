 ...
 */
public class TCFC012 extends TestCore {
    @BeforeMethod
    ...
    public void TCFC012_FLEET_CLAIMS_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.claims", "fleet.menu.claims.enquiry");
        driverwait();
        driverwait();
        Generics.CheckBoxSelect("Yard Damage", "claims.field.yarddamage");
