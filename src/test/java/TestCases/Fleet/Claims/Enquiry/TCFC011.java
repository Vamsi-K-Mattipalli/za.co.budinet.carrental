 ...
 */
public class TCFC011 extends TestCore {
    @BeforeMethod
    ...
    public void TCFC011_FLEET_CLAIMS_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.claims", "fleet.menu.claims.enquiry");
        driverwait();
        driverwait();
        Generics.FieldPopulate("Movement No", "claims.field.movementno", "Gauteng");
