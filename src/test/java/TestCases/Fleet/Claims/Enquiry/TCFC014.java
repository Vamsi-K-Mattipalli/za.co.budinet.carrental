 ...
 */
public class TCFC014 extends TestCore {
    @BeforeMethod
    ...
    public void TCFC014_FLEET_CLAIMS_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.claims", "fleet.menu.claims.enquiry");
        driverwait();
        driverwait();
        Generics.CheckBoxSelect("Non Rev Damage", "claims.field.nonrevdamage");
