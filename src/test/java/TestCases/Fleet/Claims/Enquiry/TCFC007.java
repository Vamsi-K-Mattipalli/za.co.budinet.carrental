 ...
 */
public class TCFC007 extends TestCore {
    @BeforeMethod
    ...
    public void TCFC007_FLEET_CLAIMS_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.claims", "fleet.menu.claims.enquiry");
        driverwait();
        driverwait();
        Generics.FieldPopulate("Claim No", "claims.field.claimno", "AU6112287");
