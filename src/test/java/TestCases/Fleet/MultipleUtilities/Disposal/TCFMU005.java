 ...
 */
public class TCFMU005 extends TestCore {
    @BeforeMethod
    ...
    public void TCFMU005_FLEET_MULTIPLEUTILITIES_DISPOSAL(String Username, String Password) throws Exception {
        ...
        Generics.ClearTextField("disposal.field.sellprice");
