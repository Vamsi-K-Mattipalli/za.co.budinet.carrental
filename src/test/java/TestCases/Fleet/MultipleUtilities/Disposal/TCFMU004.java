 ...
 */
public class TCFMU004 extends TestCore {
    @BeforeMethod
    ...
    public void TCFMU004_FLEET_MULTIPLEUTILITIES_DISPOSAL(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Date", "disposal.field.date", "2019-01-01");
