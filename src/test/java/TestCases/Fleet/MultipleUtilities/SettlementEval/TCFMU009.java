 ...
 */
public class TCFMU009 extends TestCore {
    @BeforeMethod
    ...
    public void TCFMU009_FLEET_MULTIPLEUTILITIES_SETTLEMENTEVAL(String Username, String Password) throws Exception {
        ...
        Generics.FieldPopulate("Reg No", "disposal.field.regno", "FJ33GYGP");
