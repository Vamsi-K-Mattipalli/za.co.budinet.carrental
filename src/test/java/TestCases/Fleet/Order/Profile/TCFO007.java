 ...
 */
public class TCFO007 extends TestCore {
    @BeforeMethod
    ...
    public void TCFO007_FLEET_ORDER_PROFILE(String Username, String Password) throws Exception {
      ...
      ///  Generics.FieldPopulate("Repurchase Price", "order.field.repuchaseprice", "150000");
