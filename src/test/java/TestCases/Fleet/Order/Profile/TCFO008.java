 ...
 */
public class TCFO008 extends TestCore {
    @BeforeMethod
    ...
    public void TCFO008_FLEET_ORDER_PROFILE(String Username, String Password) throws Exception {
     ...
     //   Generics.FieldPopulate("Repurchase Price", "order.field.repuchaseprice", "120000");
