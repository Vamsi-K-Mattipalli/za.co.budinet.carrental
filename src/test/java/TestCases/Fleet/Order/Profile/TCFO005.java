...
//import static controlers.GlobalMessages.V002;

/**
 * Created by GregDev on 2017/05/16.
 */
public class TCFO005 extends TestCore {
    @BeforeMethod
    ...
    public void TCFO005_FLEET_ORDER_PROFILE(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.order", "fleet.menu.order.profile");
        driverwait();
        //OrderLoad.DealerSelect();
      //  OrderLoad.Populate();
      //  Generics.ClearDropDownField("order.field.contacttype");
