 ...
 */
public class TCFFS006 extends TestCore {
    @BeforeMethod
    ...
    public void TCFFS006_FLEET_FINANCESCHEME_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        driverwait();
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.financeclaim", "fleet.menu.financeclaim.enquiry");
        driverwait();
        Generics.FieldPopulate("Finance From Date", "finance.field.fromdate", "2016-01-01");
