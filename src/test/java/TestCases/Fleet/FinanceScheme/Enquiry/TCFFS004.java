 ...
 */
public class TCFFS004 extends TestCore {
    @BeforeMethod
    ...
    public void TCFFS004_FLEET_FINANCESCHEME_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.financeclaim", "fleet.menu.financeclaim.enquiry");
        driverwait();
        Generics.DropdownSelector("Finance House", "finance.field.house", "Bidvest Bank");
