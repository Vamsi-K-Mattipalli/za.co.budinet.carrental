 ...
 */
public class TCFFS005 extends TestCore {
    @BeforeMethod
    ...
    public void TCFFS005_FLEET_FINANCESCHEME_ENQUIRY(String Username, String Password) throws Exception {
        LogIn.SignIn(Username, Password);
        Menu.NavigateTo3("fleet.menu.fleet", "fleet.menu.financeclaim", "fleet.menu.financeclaim.enquiry");
        driverwait();
        Generics.FieldPopulate("Finance Code", "finance.field.code", "BID");
